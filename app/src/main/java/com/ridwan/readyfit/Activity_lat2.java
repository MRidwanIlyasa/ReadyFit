...
public class Activity_lat2 extends AppCompatActivity {
    ListView listView1;
    String mTitle [] = {" Loncat Bintang "," Crunch Perut "," Naik Turuk Bangku "," Push Up ","Plank"};
    String mDesc [] = {"x15","x7 - x13 (Bertambah x1 setiap hari)","x5 - x11 (Bertambah x1 setiap hari)"
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0 ){
                    ...
                    Intent i = new Intent(getApplicationContext(),MainLatNaikbangku.class);
                    startActivity(i);
                } if(position == 3 ){
